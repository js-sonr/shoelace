...
describe('<nu-list-item>', () => {
  ...
  it('should display status indicator', async () => {
    const el = await fixture<NuListItem>(html` 
      <nu-list-item title="Transaction" status="pending"></nu-list-item> 
    `);
  ...
  it('should emit click event when clicked', async () => {
    const el = await fixture<NuListItem>(html` 
      <nu-list-item title="Clickable Item" clickable></nu-list-item> 
    `);
  ...
  it('should apply correct styling for different types', async () => {
    ...
    `);
    const balanceEl = await fixture<NuListItem>(html` 
      <nu-list-item type="balance" title="Balance"></nu-list-item> 
    `);
