...
import type NuCheckbox from './checkbox.js';

describe('<nu-checkbox>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<NuCheckbox>(html` <nu-checkbox>Checkbox</nu-checkbox> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<NuCheckbox>(html` <nu-checkbox></nu-checkbox> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<NuCheckbox>(html` <nu-checkbox title="Test"></nu-checkbox> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<NuCheckbox>(html` <nu-checkbox disabled></nu-checkbox> `);
  ...
  describe('when submitting a form', () => {
    it('should submit the correct value when a value is provided', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <nu-checkbox name="a" value="1" checked></nu-checkbox>
    ...
    it('should submit "on" when no value is provided', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <nu-checkbox name="a" checked></nu-checkbox>
          <nu-button type="submit">Submit</nu-button>
        </form>
      `);
      const button = form.querySelector('nu-button')!;
    ...
    it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <nu-checkbox></nu-checkbox> `);
    ...
    it('should be invalid when required and unchecked', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <nu-checkbox required></nu-checkbox> `);
      expect(checkbox.checkValidity()).to.be.false;
    });

    it('should be valid when required and checked', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <nu-checkbox required checked></nu-checkbox> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <nu-checkbox form="f" name="a" value="1" checked></nu-checkbox>
        </div>
      `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><nu-checkbox required></nu-checkbox></form> `);
      const checkbox = el.querySelector<NuCheckbox>('nu-checkbox')!;
  ...
  describe('when resetting a form', () => {
    it('should reset the element to its initial value', async () => {
      ...
      `);
      const button = form.querySelector('nu-button')!;
      const checkbox = form.querySelector('nu-checkbox')!;
  ...
  describe('focus', () => {
    ...
    it('should not jump the page to the bottom when focusing a checkbox at the bottom of an element with overflow: auto;', async () => {
      ...
      const checkboxes = el.querySelectorAll<NuCheckbox>('nu-checkbox');
  ...
  describe('indeterminate', () => {
    it('should render indeterminate icon until checked', async () => {
      const el = await fixture<NuCheckbox>(html`<nu-checkbox indeterminate></nu-checkbox>`);
