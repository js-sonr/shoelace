...
import type NuCarousel from './carousel.js';

describe('<nu-carousel>', () => {
  ...
  it('should render a carousel with default configuration', async () => {
    ...
    const el = await fixture(html`
      <nu-carousel>
        <nu-carousel-item>Node 1</nu-carousel-item>
        <nu-carousel-item>Node 2</nu-carousel-item>
        <nu-carousel-item>Node 3</nu-carousel-item>
      </nu-carousel>
    `);
  ...
  describe('when `autoplay` attribute is provided', () => {
    ...
    it('should scroll forwards every `autoplay-interval` milliseconds', async () => {
      // Arrange
      const el = await fixture<NuCarousel>(html`
        <nu-carousel autoplay autoplay-interval="10">
          <nu-carousel-item>Node 1</nu-carousel-item>
          <nu-carousel-item>Node 2</nu-carousel-item>
          <nu-carousel-item>Node 3</nu-carousel-item>
        </nu-carousel>
  ...
  describe('when `loop` attribute is provided', () => {
    ...
    describe('and `slides-per-page` is provided', () => {
      it('should create multiple clones', async () => {
        // Arrange
        const el = await fixture<NuCarousel>(html`
          <nu-carousel loop slides-per-page="2">
            <nu-carousel-item>Node 1</nu-carousel-item>
            <nu-carousel-item>Node 2</nu-carousel-item>
            <nu-carousel-item>Node 3</nu-carousel-item>
          </nu-carousel>
      ...
      it(`should display ${expected} pages for ${slides} slides grouped by ${slidesPerPage} and scrolled by ${slidesPerMove}${
        ...
        const el = await fixture<NuCarousel>(html`
          <nu-carousel
            ...
            ?loop=${loop}
          >
            ${map(range(slides), i => html`<nu-carousel-item>${i}</nu-carousel-item>`)}
          </nu-carousel>
        `);
  ...
  describe('when `slides-per-move` attribute is provided', () => {
    it('should set the granularity of snapping', async () => {
      ...
      const el = await fixture<NuCarousel>(html`
        <nu-carousel slides-per-page="${expectedSnapGranularity}" slides-per-move="${expectedSnapGranularity}">
          <nu-carousel-item>Node 1</nu-carousel-item>
          <nu-carousel-item>Node 2</nu-carousel-item>
          <nu-carousel-item>Node 3</nu-carousel-item>
          <nu-carousel-item>Node 4</nu-carousel-item>
        </nu-carousel>
      `);
    ...
    it('should be possible to move by the given number of slides at a time', async () => {
      // Arrange
      const el = await fixture<NuCarousel>(html`
        <nu-carousel navigation slides-per-move="2" slides-per-page="2">
          <nu-carousel-item>Node 1</nu-carousel-item>
          <nu-carousel-item>Node 2</nu-carousel-item>
          <nu-carousel-item class="expected">Node 3</nu-carousel-item>
          <nu-carousel-item class="expected">Node 4</nu-carousel-item>
          <nu-carousel-item>Node 5</nu-carousel-item>
          <nu-carousel-item>Node 6</nu-carousel-item>
        </nu-carousel>
      `);
    ...
    it('should be possible to move by a number that is less than the displayed number', async () => {
      // Arrange
      const el = await fixture<NuCarousel>(html`
        <nu-carousel navigation slides-per-move="1" slides-per-page="2">
          <nu-carousel-item>Node 1</nu-carousel-item>
          <nu-carousel-item>Node 2</nu-carousel-item>
          <nu-carousel-item>Node 3</nu-carousel-item>
          <nu-carousel-item>Node 4</nu-carousel-item>
          <nu-carousel-item class="expected">Node 5</nu-carousel-item>
          <nu-carousel-item class="expected">Node 6</nu-carousel-item>
        </nu-carousel>
      `);
      const expectedSlides = el.querySelectorAll('.expected')!;
      const nextButton: HTMLElement = el.shadowRoot!.querySelector('.carousel__navigation-button--next')!;
    ...
    it('should not be possible to move by a number that is greater than the displayed number', async () => {
      ...
      const el = await fixture<NuCarousel>(html`
        <nu-carousel slides-per-page="${expectedSlidesPerMove}">
          <nu-carousel-item>Node 1</nu-carousel-item>
          <nu-carousel-item>Node 2</nu-carousel-item>
          <nu-carousel-item>Node 3</nu-carousel-item>
          <nu-carousel-item>Node 4</nu-carousel-item>
  ...
  describe('when `orientation` attribute is provided', () => {
    describe('and value is `vertical`', () => {
      it('should make the scrollable along the y-axis', async () => {
        // Arrange
        const el = await fixture<NuCarousel>(html`
          <nu-carousel orientation="vertical" style="height: 100px">
            <nu-carousel-item>Node 1</nu-carousel-item>
            <nu-carousel-item>Node 2</nu-carousel-item>
          </nu-carousel>
        `);
    ...
    describe('and value is `horizontal`', () => {
      it('should make the scrollable along the x-axis', async () => {
        // Arrange
        const el = await fixture<NuCarousel>(html`
          <nu-carousel orientation="horizontal" style="height: 100px">
            <nu-carousel-item>Node 1</nu-carousel-item>
            <nu-carousel-item>Node 2</nu-carousel-item>
          </nu-carousel>
        `);
  ...
  describe('when `mouse-dragging` attribute is provided', () => {
    ...
    it('should be possible to interact with clickable elements', async () => {
      ...
      const el = await fixture<NuCarousel>(html`
        <nu-carousel mouse-dragging>
          <nu-carousel-item><button>click me</button></nu-carousel-item>
          <nu-carousel-item>Node 2</nu-carousel-item>
          <nu-carousel-item>Node 3</nu-carousel-item>
        </nu-carousel>
      `);
  ...
  describe('API', () => {
    describe('#next', () => {
      it('should scroll the carousel to the next slide', async () => {
        ...
        const expectedCarouselItem: HTMLElement = el.querySelector('nu-carousel-item:nth-child(2)')!;
    ...
    describe('#previous', () => {
      it('should scroll the carousel to the previous slide', async () => {
        ...
        `);
        const expectedCarouselItem: HTMLElement = el.querySelector('nu-carousel-item:nth-child(1)')!;
  ...
  describe('Accessibility', () => {
    it('should pass accessibility tests', async () => {
      // Arrange
      const el = await fixture<NuCarousel>(html`
        <nu-carousel navigation pagination>
          <nu-carousel-item>Node 1</nu-carousel-item>
          <nu-carousel-item>Node 2</nu-carousel-item>
          <nu-carousel-item>Node 3</nu-carousel-item>
        </nu-carousel>
