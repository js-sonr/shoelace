...
var e2 = class extends i {
  constructor(i2) {
    if (super(i2), this.et = T, i2.type !== t.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(r) {
    if (r === T || null == r) return this.vt = void 0, this.et = r;
    if (r === w) return r;
