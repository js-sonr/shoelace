import {
  NuVisuallyHidden
} from "./chunk.IIZFOKHY.js";
import {
  NuInput
} from "./chunk.TOOGIPJR.js";
import {
  drag
...
var NuColorPicker = class extends NebulaElement {
  constructor() {
    super();
...
NuColorPicker.styles = [component_styles_default, color_picker_styles_default];
NuColorPicker.dependencies = {
...
__decorateClass([
  e2('[part~="base"]')
], NuColorPicker.prototype, "base", 2);
__decorateClass([
  e2('[part~="input"]')
], NuColorPicker.prototype, "input", 2);
__decorateClass([
  e2(".color-dropdown")
], NuColorPicker.prototype, "dropdown", 2);
__decorateClass([
  e2('[part~="preview"]')
], NuColorPicker.prototype, "previewButton", 2);
__decorateClass([
  e2('[part~="trigger"]')
], NuColorPicker.prototype, "trigger", 2);
__decorateClass([
  r()
], NuColorPicker.prototype, "hasFocus", 2);
__decorateClass([
  r()
], NuColorPicker.prototype, "isDraggingGridHandle", 2);
__decorateClass([
  r()
], NuColorPicker.prototype, "isEmpty", 2);
__decorateClass([
  r()
], NuColorPicker.prototype, "inputValue", 2);
__decorateClass([
  r()
], NuColorPicker.prototype, "hue", 2);
__decorateClass([
  r()
], NuColorPicker.prototype, "saturation", 2);
__decorateClass([
  r()
], NuColorPicker.prototype, "brightness", 2);
__decorateClass([
  r()
], NuColorPicker.prototype, "alpha", 2);
__decorateClass([
  n()
], NuColorPicker.prototype, "value", 2);
__decorateClass([
  defaultValue()
], NuColorPicker.prototype, "defaultValue", 2);
__decorateClass([
  n()
], NuColorPicker.prototype, "label", 2);
__decorateClass([
  n()
], NuColorPicker.prototype, "format", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuColorPicker.prototype, "inline", 2);
__decorateClass([
  n({ reflect: true })
], NuColorPicker.prototype, "size", 2);
__decorateClass([
  n({ attribute: "no-format-toggle", type: Boolean })
], NuColorPicker.prototype, "noFormatToggle", 2);
__decorateClass([
  n()
], NuColorPicker.prototype, "name", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuColorPicker.prototype, "disabled", 2);
__decorateClass([
  n({ type: Boolean })
], NuColorPicker.prototype, "hoist", 2);
__decorateClass([
  n({ type: Boolean })
], NuColorPicker.prototype, "opacity", 2);
__decorateClass([
  n({ type: Boolean })
], NuColorPicker.prototype, "uppercase", 2);
__decorateClass([
  n()
], NuColorPicker.prototype, "swatches", 2);
__decorateClass([
  n({ reflect: true })
], NuColorPicker.prototype, "form", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuColorPicker.prototype, "required", 2);
__decorateClass([
  t({ passive: false })
], NuColorPicker.prototype, "handleTouchMove", 1);
__decorateClass([
  watch("format", { waitUntilFirstUpdate: true })
], NuColorPicker.prototype, "handleFormatChange", 1);
__decorateClass([
  watch("opacity", { waitUntilFirstUpdate: true })
], NuColorPicker.prototype, "handleOpacityChange", 1);
__decorateClass([
  watch("value")
], NuColorPicker.prototype, "handleValueChange", 1);
