...
var NuDetails = class extends NebulaElement {
  constructor() {
    super(...arguments);
...
NuDetails.styles = [component_styles_default, details_styles_default];
NuDetails.dependencies = {
  "nu-icon": NuIcon
};
__decorateClass([
  e2(".details")
], NuDetails.prototype, "details", 2);
__decorateClass([
  e2(".details__header")
], NuDetails.prototype, "header", 2);
__decorateClass([
  e2(".details__body")
], NuDetails.prototype, "body", 2);
__decorateClass([
  e2(".details__expand-icon-slot")
], NuDetails.prototype, "expandIconSlot", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuDetails.prototype, "open", 2);
__decorateClass([
  n()
], NuDetails.prototype, "summary", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuDetails.prototype, "disabled", 2);
__decorateClass([
  watch("open", { waitUntilFirstUpdate: true })
], NuDetails.prototype, "handleOpenChange", 1);
