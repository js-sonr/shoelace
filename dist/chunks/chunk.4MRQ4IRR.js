...
var NuImageComparer = class extends NebulaElement {
  constructor() {
    super(...arguments);
    this.position = 50;
  }
...
NuImageComparer.styles = [component_styles_default, image_comparer_styles_default];
NuImageComparer.scopedElement = { "sl-icon": NuIcon };
__decorateClass([
  e2(".image-comparer")
], NuImageComparer.prototype, "base", 2);
__decorateClass([
  e2(".image-comparer__handle")
], NuImageComparer.prototype, "handle", 2);
__decorateClass([
  n({ type: Number, reflect: true })
], NuImageComparer.prototype, "position", 2);
__decorateClass([
  watch("position", { waitUntilFirstUpdate: true })
], NuImageComparer.prototype, "handlePositionChange", 1);
