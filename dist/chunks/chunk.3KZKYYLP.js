...
var P = (t3, i4) => {
  ...
  for (let i5 = 0; i5 < s4; i5++) {
    const s5 = t3[i5];
    let a3, u3, d3 = -1, y3 = 0;
    for (; y3 < s5.length && (c4.lastIndex = y3, u3 = c4.exec(s5), null !== u3); ) y3 = c4.lastIndex, c4 === f ? "!--" === u3[1] ? c4 = v : void 0 !== u3[1] ? c4 = _ : void 0 !== u3[2] ? ($.test(u3[2]) && (r5 = RegExp("</" + u3[2], "g")), c4 = m) : void 0 !== u3[3] && (c4 = m) : c4 === m ? ">" === u3[0] ? (c4 = r5 != null ? r5 : f, d3 = -1) : void 0 === u3[1] ? d3 = -2 : (d3 = c4.lastIndex - u3[2].length, a3 = u3[1], c4 = void 0 === u3[3] ? m : '"' === u3[3] ? g : p) : c4 === g || c4 === p ? c4 = m : c4 === v || c4 === _ ? c4 = f : (c4 = m, r5 = void 0);
      ...
      if (1 === r5.nodeType) {
        ...
        if ($.test(r5.tagName)) {
          ...
          if (s5 > 0) {
            ...
            for (let i4 = 0; i4 < s5; i4++) r5.append(t4[i4], l()), E.nextNode(), d3.push({ type: 2, index: ++c4 });
            r5.append(t4[s5], l());
          }
        }
...
var M = class _M {
  ...
  g(t3) {
    ...
    if (((_a6 = this._$AH) == null ? void 0 : _a6._$AD) === e4) this._$AH.p(i4);
    else {
  ...
  T(t3) {
    ...
    const i4 = this._$AH;
    let s4, e4 = 0;
    for (const h3 of t3) e4 === i4.length ? i4.push(s4 = new _M(this.k(l()), this.k(l()), this, this.options)) : s4 = i4[e4], s4._$AI(h3), e4++;
...
var R = class {
  ...
  _$AI(t3, i4 = this, s4, e4) {
    ...
    let o4 = false;
    if (void 0 === h3) t3 = N(this, t3, i4, 0), o4 = !c(t3) || t3 !== this._$AH && t3 !== w, o4 && (this._$AH = t3);
    else {
      const e5 = t3;
      let n4, r5;
      for (t3 = h3[0], n4 = 0; n4 < h3.length - 1; n4++) r5 = N(this, e5[s4 + n4], i4, n4), r5 === w && (r5 = this._$AH[n4]), o4 || (o4 = !c(r5) || r5 !== this._$AH[n4]), r5 === T ? t3 = T : t3 !== T && (t3 += (r5 != null ? r5 : "") + h3[n4 + 1]), this._$AH[n4] = r5;
    }
    o4 && !e4 && this.O(t3);
  }
  O(t3) {
...
var I = class extends R {
  ...
  _$AI(t3, i4 = this) {
    var _a6;
    if ((t3 = (_a6 = N(this, t3, i4, 0)) != null ? _a6 : T) === w) return;
...
var S2 = (s4, o4) => {
  if (e2) s4.adoptedStyleSheets = o4.map((t3) => t3 instanceof CSSStyleSheet ? t3 : t3.styleSheet);
...
var b2 = class extends HTMLElement {
  ...
  static finalizeStyles(s4) {
    ...
    if (Array.isArray(s4)) {
      ...
      for (const s5 of e4) i4.unshift(c2(s5));
    } else void 0 !== s4 && i4.push(c2(s4));
    return i4;
  }
  static _$Eu(t3, s4) {
  ...
  requestUpdate(t3, s4, i4, e4 = false, r5) {
    var _a6;
    if (void 0 !== t3) {
      if (i4 != null ? i4 : i4 = this.constructor.getPropertyOptions(t3), !((_a6 = i4.hasChanged) != null ? _a6 : f2)(e4 ? r5 : this[t3], s4)) return;
      this.C(t3, s4, i4);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t4.size > 0) for (const [s5, i4] of t4) true !== i4.wrapped || this._$AL.has(s5) || void 0 === this[s5] || this.C(s5, this[s5], i4);
    }
    let t3 = false;
    const s4 = this._$AL;
    try {
