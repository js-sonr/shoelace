...
var NuSplitPanel = class extends NebulaElement {
  constructor() {
    super(...arguments);
...
NuSplitPanel.styles = [component_styles_default, split_panel_styles_default];
__decorateClass([
  e(".divider")
], NuSplitPanel.prototype, "divider", 2);
__decorateClass([
  n({ type: Number, reflect: true })
], NuSplitPanel.prototype, "position", 2);
__decorateClass([
  n({ attribute: "position-in-pixels", type: Number })
], NuSplitPanel.prototype, "positionInPixels", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuSplitPanel.prototype, "vertical", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuSplitPanel.prototype, "disabled", 2);
__decorateClass([
  n()
], NuSplitPanel.prototype, "primary", 2);
__decorateClass([
  n()
], NuSplitPanel.prototype, "snap", 2);
__decorateClass([
  n({ type: Number, attribute: "snap-threshold" })
], NuSplitPanel.prototype, "snapThreshold", 2);
__decorateClass([
  watch("position")
], NuSplitPanel.prototype, "handlePositionChange", 1);
__decorateClass([
  watch("positionInPixels")
], NuSplitPanel.prototype, "handlePositionInPixelsChange", 1);
__decorateClass([
  watch("vertical")
], NuSplitPanel.prototype, "handleVerticalChange", 1);
