...
var NuDrawer = class extends NebulaElement {
  constructor() {
    super(...arguments);
...
NuDrawer.styles = [component_styles_default, drawer_styles_default];
NuDrawer.dependencies = { "nu-icon-button": NuIconButton };
__decorateClass([
  e2(".drawer")
], NuDrawer.prototype, "drawer", 2);
__decorateClass([
  e2(".drawer__panel")
], NuDrawer.prototype, "panel", 2);
__decorateClass([
  e2(".drawer__overlay")
], NuDrawer.prototype, "overlay", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuDrawer.prototype, "open", 2);
__decorateClass([
  n({ reflect: true })
], NuDrawer.prototype, "label", 2);
__decorateClass([
  n({ reflect: true })
], NuDrawer.prototype, "placement", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuDrawer.prototype, "contained", 2);
__decorateClass([
  n({ attribute: "no-header", type: Boolean, reflect: true })
], NuDrawer.prototype, "noHeader", 2);
__decorateClass([
  watch("open", { waitUntilFirstUpdate: true })
], NuDrawer.prototype, "handleOpenChange", 1);
__decorateClass([
  watch("contained", { waitUntilFirstUpdate: true })
], NuDrawer.prototype, "handleNoModalChange", 1);
