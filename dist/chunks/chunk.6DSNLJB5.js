...
var NuCarousel = class extends NebulaElement {
  constructor() {
    super(...arguments);
    this.loop = false;
...
NuCarousel.styles = [component_styles_default, carousel_styles_default];
NuCarousel.dependencies = { "nu-icon": NuIcon };
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuCarousel.prototype, "loop", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuCarousel.prototype, "navigation", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuCarousel.prototype, "pagination", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], NuCarousel.prototype, "autoplay", 2);
__decorateClass([
  n({ type: Number, attribute: "autoplay-interval" })
], NuCarousel.prototype, "autoplayInterval", 2);
__decorateClass([
  n({ type: Number, attribute: "slides-per-page" })
], NuCarousel.prototype, "slidesPerPage", 2);
__decorateClass([
  n({ type: Number, attribute: "slides-per-move" })
], NuCarousel.prototype, "slidesPerMove", 2);
__decorateClass([
  n()
], NuCarousel.prototype, "orientation", 2);
__decorateClass([
  n({ type: Boolean, reflect: true, attribute: "mouse-dragging" })
], NuCarousel.prototype, "mouseDragging", 2);
__decorateClass([
  e2(".carousel__slides")
], NuCarousel.prototype, "scrollContainer", 2);
__decorateClass([
  e2(".carousel__pagination")
], NuCarousel.prototype, "paginationContainer", 2);
__decorateClass([
  r()
], NuCarousel.prototype, "activeSlide", 2);
__decorateClass([
  r()
], NuCarousel.prototype, "scrolling", 2);
__decorateClass([
  r()
], NuCarousel.prototype, "dragging", 2);
__decorateClass([
  t({ passive: true })
], NuCarousel.prototype, "handleScroll", 1);
__decorateClass([
  watch("loop", { waitUntilFirstUpdate: true }),
  watch("slidesPerPage", { waitUntilFirstUpdate: true })
], NuCarousel.prototype, "initializeSlides", 1);
__decorateClass([
  watch("activeSlide")
], NuCarousel.prototype, "handelSlideChange", 1);
__decorateClass([
  watch("slidesPerMove")
], NuCarousel.prototype, "updateSlidesSnap", 1);
__decorateClass([
  watch("autoplay")
], NuCarousel.prototype, "handleAutoplayChange", 1);
