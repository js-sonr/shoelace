...
var NuQrCode = class extends NebulaElement {
  constructor() {
    super(...arguments);
    this.value = "";
    this.label = "";
...
NuQrCode.styles = [component_styles_default, qr_code_styles_default];
__decorateClass([
  e("canvas")
], NuQrCode.prototype, "canvas", 2);
__decorateClass([
  n()
], NuQrCode.prototype, "value", 2);
__decorateClass([
  n()
], NuQrCode.prototype, "label", 2);
__decorateClass([
  n({ type: Number })
], NuQrCode.prototype, "size", 2);
__decorateClass([
  n()
], NuQrCode.prototype, "fill", 2);
__decorateClass([
  n()
], NuQrCode.prototype, "background", 2);
__decorateClass([
  n({ type: Number })
], NuQrCode.prototype, "radius", 2);
__decorateClass([
  n({ attribute: "error-correction" })
], NuQrCode.prototype, "errorCorrection", 2);
__decorateClass([
  watch(["background", "errorCorrection", "fill", "radius", "size", "value"])
], NuQrCode.prototype, "generate", 1);
