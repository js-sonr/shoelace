...
- If you're using the CDN, [import them from the CDN](https://www.jsdelivr.com/package/npm/@sonr.io/nebula?path=%CDNDIR%%2Ftranslations)
- If you're using a bundler, import them from `@sonr.io/nebula/%NPMDIR%/translations/[lang].js`
...
```js
import { registerTranslation } from '@sonr.io/nebula/dist/utilities/localize';
import type { Translation } from '@sonr.io/nebula/dist/utilities/localize';
