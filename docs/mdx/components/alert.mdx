...
<Tabs items={['Preview', 'Web Component', 'React']}>
  ...
  <Tab value="React">
    ```tsx import SlAlert from '@sonr.io/nebula/dist/react/alert' ; import SlIcon from '@sonr.io/nebula/dist/react/icon' ;
    const App = () => (
    <NuAlert open>
...
<Tabs items={['Preview', 'Web Component', 'React']}>
  ...
  <Tab value="React">
    ```tsx import SlAlert from '@sonr.io/nebula/dist/react/alert' ; const App = () => (
    <NuAlert variant="primary" open>
      Nothing fancy here, just a simple alert.
    </NuAlert>
    ); ```
